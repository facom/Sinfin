...
<p>
  ...
  sistema y
  use <a href="$SITEURL/movilidad$VER.php?mode=editar&movilid=$movilid&action=loadmovil">el
...
M;
  ...
  //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    $urlapoyo="$SITEURL/movilidad$VER.php?action=apoyo&resultado=apoyo&movilid=$movilid&codigo=$codigo";
    $urldevol="$SITEURL/movilidad$VER.php?action=apoyo&resultado=devol&movilid=$movilid&codigo=$codigo";
    $urlmovil="$SITEURL/movilidad$VER.php?mode=ver&movilid=$movilid";
...
<p>
  ...
  usando <a href="$SITEURL/movilidad$VER.php?mode=editar&movilid=$movilid&action=loadmovil">este
  enlace</a>.
</p>
<p>Atentamente,</p>
<p>
...
C;
  ...
  if($action=="Cargar"){
    ...
    if($movilfile["size"]>0){
      ...
      include("$movildir/movilidad$VER.php");
      $movilid=$movilidnew;
...
<th class="header"><a href=movilidad$VER.php?mode=lista&sort=movilid&order=$order>ID</a></th>
<th class="header"><a href=movilidad$VER.php?mode=lista&sort=estado&order=$order>Estado</a></th>
<th class="header"><a href=movilidad$VER.php?mode=lista&sort=TIMESTAMP(fechapresenta)&order=$order>Fecha estado</a></th>
<th colspan=2 class="header"><a href=movilidad$VER.php?mode=lista&sort=TIMESTAMP(fechaini)&order=$order>Fechas evento</a></th>
<th class="header"><a href=movilidad$VER.php?mode=lista&sort=documento&order=$order>Documento</a></th>
<th class="header"><a href=movilidad$VER.php?mode=lista&sort=movilid&order=$order>Nombre</a></th>
...
T;
    ...
    foreach($results as $movil){
      ...
      //ID
      $table.="<td class='listacampo'><a href=movilidad$VER.php?mode=editar&movilid=$movilid&action=loadmovil>";
      $table.=$movilid;
      $table.="</a></td>";
      ...
      $table.="<td class='listacampo'><a href=movilidad$VER.php?mode=lista&search=$searchurl>";
      $table.=$documento;
      $table.="</a></td>";
	...
	$compromisotxt="<a target=_blank href='$movildir/$compromiso'>Compromiso</a>";
      ...
      $descargatxt="<a href='movilidad$VER.php?action=descargar&movilid=$movilid'>Descargar</a>";
...
$cargar=<<<C
<div class="escondida">
<form action="movilidad$VER.php" method="post" enctype="multipart/form-data" accept-charset="utf-8">
...
<center>
$cargar
<form action="movilidad$VER.php?loadmovil" method="post" enctype="multipart/form-data" accept-charset="utf-8">
...
FORM;
  ...
  //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    $content.="<script>window.location.href='movilidad$VER.php';</script>";
    goto end;
  }
