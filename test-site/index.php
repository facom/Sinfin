<!DOCTYPE html>
<html prefix="og: http://ogp.me/ns#" class="no-js" xmlns="http://www.w3.org/1999/xhtml" xml:lang="" lang="" slick-uniqueid="3"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <!--<base href="http://extension.medicinaudea.co/index.php/programas">--><base href=".">
    <meta property="og:url" content="http://fcen-udea.co/principal/Sinfin/index.php">
    <meta property="og:title" content="SInfIn">
...
<header id="header" class="fixed">
  ...
  <div class="grupo movil-tabla"> 
    ...
    <div class="caja movil-50 izquierda-contenido">
      <div class="logo">
        <a href="http://extension.medicinaudea.co/index.php"><img src="./Programas_files/LogoFCEN.gif"></a>
      </div>
    </div>
    ...
    <div class="caja movil-50 derecha-contenido" style="color:#376133">
      ...
      <h3 style="font-weight:bold;">SInfIn</h3>
      <span style="font-family:Times New Roman;">Sistema de Información Curricular Integrada</span>
    </div>
...
<section id="componente">
  <div class="grupo">
    <div class="caja tablet-100">
      <div id="clr"></div>
      <br/>
      Curso de evaluación económica de 36 horas, dictado por el profesor
      Aurelio Mejía Mejía, Economista, MSc en Economía de la Salud. El
      curso tendrá como objetivo conocer y aplicar las principales
      técnicas de la evaluación económica en salud y comprender su
      aporte en el proceso de toma de decisiones en salud.
    </div>
</section>
...
<footer id="footer">
  <section id="footer_bottom">
    <div class="grupo tablet-tabla" style="font-size:0.8em;font-style:italic;padding:20px">
      Esta conectado como Jorge Zuluaga (visitante)<br/>
      Última actualización: Thu, 11 Aug 2016 10:29:35 -0500<br/>
